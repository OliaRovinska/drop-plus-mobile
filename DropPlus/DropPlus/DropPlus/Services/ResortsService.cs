            ...
            Resorts = new List<ResortModel>()
            {
                ...
                new ResortModel()
                {
                    ...
                    Reviews = new List<ReviewModel>()
                    {
                        ...
                        {
                            Rating = 3,
                            Text = "Років 5-6 лікуюся в Хмільнику профсоюзному.Мене 'поставили на ноги' в прямому значенні.Обожнюю цей санаторій.Дуже люблю Юрія Юрієвича (витяжка).Весь персонал доброзичливий.Територія охайна.Все дуже класно.І ціна більш-менш тримається,що дуже важливо в наш час.",
                            User = UsersService.Get("melnyk@gmail.com")
                        }
                    }
                },
